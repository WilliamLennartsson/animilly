...
function App() {
    return(
      ...
      <Provider store={Store}>
        <div className="w-screen h-screen text-center m-0">
          <AppRouter />
        </div>
      </Provider>
    );
 ...
 *  return (
    <div className="h-screen w-screen">
      ...
      <main className="flex w-full">
        <aside className="w-80 bg-gray shadow-md w-fulll hidden sm:block">
        ...
        <section className="w-full p-4">
          <div className="w-full h-auto border-dashed border-4 p-4 text-md">Dashboard</div>
        </section>
      </main>
    </div>
 */
